  ...
  render() {
    return (
      <div className="container Example">
        ...
        <input type="text" value={this.state.motto} onChange={this.handleChangeMotto} />
        <div className="motto-update cs142-example-output">
...
`<p>My name is "{this.state.name}".</p>`
        ...
        <p className="cs142-example-output special">
